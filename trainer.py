...
#         print(images.shape)
        ...
        loss = self.loss_classification(preds, labels)
    ...
    def iterate(self, epoch, phase):
        ...
        for itr, batch in enumerate(tk0):
            ...
            loss, outputs, preds = self.forward(images, targets, labels)
    ...
    def train_end(self):
        ...
        df_data=np.array([train_loss, train_dice, train_iou, val_loss,val_dice, val_iou]).T
        df = pd.DataFrame(df_data,columns = ['train_loss','train_dice','train_iou', 'val_loss','val_dice','val_iou'])
